...
> 2026-08-20, in **one** plan covering all three repositories, kept in the
...
## Table of content
  ...
  - [1. runtime-analysis × documentation.nvim — beyond the join already planned](#1-runtime-analysis--documentationnvim--beyond-the-join-already-planned)
    - [1.1 Churn × call count — **built 2026-08-20**](#11-churn--call-count--built-2026-08-20-documentationnvim-103ceb7)
    - [1.2 Auto-coverage × telemetry — **built 2026-08-20**](#12-auto-coverage--telemetry--built-2026-08-20-documentationnvim-103ceb7)
    ...
    - [1.8 ~~A live badge in the annotation popup~~ — built 2026-08-20](#18-a-live-badge-in-the-annotation-popup--built-2026-08-20)
  ...
  - [2. runtime-analysis × mdview.nvim — mdview as more than a renderer](#2-runtime-analysis--mdviewnvim--mdview-as-more-than-a-renderer)
    ...
    - [2.2 ~~`:MDView preview-tab` — the browser-free tier~~ — built 2026-08-20](#22-mdview-preview-tab--the-browser-free-tier--built-2026-08-20)
  ...
  - [3. Three-way — where all of them meet](#3-three-way--where-all-of-them-meet)
    ...
    - [3.4 A shared project key, so the three plugins agree what "this project" is](#34-a-shared-project-key--decided-2026-08-20-and-the-decision-is-libnvimfsproject_key)
  - [4. runtime-analysis × lib.nvim — the floor](#4-runtime-analysis--libnvim--the-floor)
    - [4.1 ~~`proc_trace` and `:RAInspect` are the same technique twice~~ — decided 2026-08-20](#41-proc_trace-and-rainspect-are-the-same-technique-twice--decided-2026-08-20-no-shared-registry)

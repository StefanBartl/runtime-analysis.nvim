...
**3 modules** · 2 namespaces · 28 helper files
...
| `runtime-analysis.telemetry` | Opt-in call counting and usage statistics for any Lua/Neovim plugin that points an instance at its own modules. | 21 | [README](../../lua/runtime-analysis/telemetry/README.md) · [src](../../lua/runtime-analysis/telemetry/init.lua) |
| &nbsp;&nbsp;`renderers` |  |  |  |

...
| `runtime-analysis.startup` | Answers "why did Neovim freeze for half a second just now", and does it in the one place where the usual tools cannot: `nvim --startuptime` stops at the first… | 14 | [src](../../lua/runtime-analysis/startup/init.lua) |
